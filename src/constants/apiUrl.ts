...
export const API_URLS = {
	...
	MATCH_DAYS: `https://scoretdi2025-eta.vercel.app/api/jornadas?torneoID=${TOURNAMENT_ID}`,
	...
	TEAMS_TABLE: `https://scoretdi2025-eta.vercel.app/api/tablaResumen?torneoID=${TOURNAMENT_ID}`,
} as const;
